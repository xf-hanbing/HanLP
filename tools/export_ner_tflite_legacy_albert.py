...
def convert_tflite(saved_model_dir: Path, tflite_path: Path, quant: str):
...
def parse_args():
    ...
    parser.add_argument("--quant", default="float16", choices=["none", "float16"], help="Quantization mode")
...
def main():
    ...
    convert_tflite(saved_model_dir, tflite_path, args.quant)
